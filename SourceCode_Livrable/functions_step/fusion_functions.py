...
file1_path = 'data/data_after_cleaning/table1_cleaned.csv'
file2_path = 'data/data_after_cleaning/table2_cleaned.csv'

# Définition des chemins (fichiers en sortie)
outer_join_file_path = 'data/data_after_merging/table_merged.csv'
outer_join_file_path_no_duplicates = 'data/data_after_merging/table_merged_no_duplicates.csv'
